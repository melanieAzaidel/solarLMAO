...
Short tutorials on <sup>8</sup>B neutrino Production, Propagation, and Detection can be found in the corresponding Jupyter Notebook (*.ipynb) files. The Notebook ratioPlot.ipynb contains our calculation of the scattered electron spectrum compared to Super-K's Monte Carlo model of their detector.  
